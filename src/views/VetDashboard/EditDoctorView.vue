        ...
        <div class="create-profile-contain">
          ...
          <div class="operational-hour" v-if="data != 0">
            ...
            >
              ...
              <template v-slot:[`item.jam_buka2`]="{ item }">
                <v-menu
                  v-model="jamBuka2[item.hari_buka]"
                  :close-on-content-click="false"
                  transition="scale-transition"
                  offset-y
                  max-width="290px"
              ...
              <template v-slot:[`item.jam_tutup2`]="{ item }">
                <v-menu
                  v-model="jamTutup2[item.hari_buka]"
                  :close-on-content-click="false"
                  transition="scale-transition"
                  offset-y
                  max-width="290px"
